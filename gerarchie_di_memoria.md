...
- [cache](#cache)
  ...
  - [Classificazione dei Miss nella Cache](#classificazione-dei-miss-nella-cache)
  - [Ottimizzazione delle Prestazioni della Cache](#ottimizzazione-delle-prestazioni-della-cache)
    - [Impatto della Dimensione della Cache e dell'Associatività](#impatto-della-dimensione-della-cache-e-dellassociatività)
    - [Impatto della Dimensione del Blocco](#impatto-della-dimensione-del-blocco)
  - [Politiche di Scrittura nella Cache](#politiche-di-scrittura-nella-cache)
    - [Tipologie di Cache per la Scrittura](#tipologie-di-cache-per-la-scrittura)
      - [**Cache Write-Through**](#cache-write-through)
      - [**Cache Write-Back**](#cache-write-back)
  - [Evoluzione delle Cache: Cause e Tendenze](#evoluzione-delle-cache-cause-e-tendenze)
- [Memoria virtuale](#memoria-virtuale)
  - [Disco Rigido nella Gerarchia di Memoria](#disco-rigido-nella-gerarchia-di-memoria)
  - [Indirizzi Virtuali e Page Fault](#indirizzi-virtuali-e-page-fault)
  - [Tabella delle Pagine e Traduzione degli Indirizzi](#tabella-delle-pagine-e-traduzione-degli-indirizzi)
  - [Translation Lookaside Buffer (TLB)](#translation-lookaside-buffer-tlb)
  - [Traduzione degli Indirizzi Virtuali in Indirizzi Fisici](#traduzione-degli-indirizzi-virtuali-in-indirizzi-fisici)
    - [Struttura degli Indirizzi](#struttura-degli-indirizzi)
    - [Processo di Traduzione](#processo-di-traduzione)
  - [Uso della Tabella delle Pagine](#uso-della-tabella-delle-pagine)
    - [Struttura e Funzionamento](#struttura-e-funzionamento)
    - [Memorizzazione e Accesso](#memorizzazione-e-accesso)
    - [Processo di Traduzione](#processo-di-traduzione-1)
    - [Impatto sulle Prestazioni](#impatto-sulle-prestazioni)
  - [Il Translation Lookaside Buffer (TLB)](#il-translation-lookaside-buffer-tlb)
    - [Località e Efficienza](#località-e-efficienza)
    - [Funzionamento del TLB](#funzionamento-del-tlb)
    - [Benefici del TLB](#benefici-del-tlb)
  - [Protezione della Memoria e Memoria Virtuale](#protezione-della-memoria-e-memoria-virtuale)
    - [Necessità della Protezione](#necessità-della-protezione)
    - [Ruolo della Memoria Virtuale](#ruolo-della-memoria-virtuale)
    - [Condivisione Controllata](#condivisione-controllata)
  - [Politiche di Scrittura e Sostituzione nella Memoria Virtuale](#politiche-di-scrittura-e-sostituzione-nella-memoria-virtuale)
    - [Politica di Scrittura: Write-Back](#politica-di-scrittura-write-back)
    - [Paging e Swap Area](#paging-e-swap-area)
    - [Politica di Sostituzione: LRU Approssimata](#politica-di-sostituzione-lru-approssimata)
    - [Gestione della Sostituzione](#gestione-della-sostituzione)
  - [Tabelle delle Pagine a Più Livelli](#tabelle-delle-pagine-a-più-livelli)
    - [Struttura a Due Livelli](#struttura-a-due-livelli)
    - [Suddivisione degli Indirizzi](#suddivisione-degli-indirizzi)
    - [Vantaggi e Svantaggi](#vantaggi-e-svantaggi-2)
